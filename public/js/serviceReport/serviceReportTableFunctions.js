...
function addRow() {
    ...
    newRow.innerHTML = `
        <td><input class="titleContent_InputField" type="text" name="item[]" placeholder="Unit"></td>
        <td><input class="titleContent_InputField" type="text" name="description[]" placeholder="Activity Perfomed"></td>
...
function updateGrandTotal() {
    const totalCells = document.querySelectorAll("#serviceReportTable tbody tr td:nth-child(5) span");
